  ...
  return (
    <>
      <div className="w-full h-screen flex flex-col relative">
        ...
        {isStart ? (
          <div className="w-full max-h-[75vh] overflow-y-scroll my-8 px-2">
            <div className="p-3 sm:p-5 flex justify-start  gap-4 sm:gap-7 ">
              <div>
                <img src={assets.user} className="w-5 fill-white" />
              </div>
              <div className="w-[95%] text-[13px] sm:text-[15px]">{input}</div>
            </div>
            <div className="p-3 sm:p-5 flex items-start justify-start gap-4 sm:gap-7">
              <div>
                <img
              ...
              {loading ? (
                ...
                <pre
                  className="w-[95%] tracking-wider whitespace-pre-wrap text-start text-[13px] sm:text-[15px]"
          ...
          <div className="w-2/3 flex p-2 bg-[#1E1F20] rounded-2xl justify-between">
            ...
            <div className="px-4 flex items-center justify-between">
              <img
                src={assets.image}
                alt="image"
                className="w-3 sm:w-4 mx-2 cursor-pointer"
              />
              <img
                src={assets.mic}
                alt="mic"
